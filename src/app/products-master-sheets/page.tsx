        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 rounded-2xl flex items-center justify-center shadow-lg" style={{ backgroundColor: '#FFD7D5' }}>
                    ...
                    {Array.from({ length: Math.min(5, pagination.totalPages) }, (_, i) => {
                      ...
                      return (
                        <button
                          ...
                          style={pageNum === pagination.page ? { backgroundColor: '#FFD7D5' } : {}}
                        >
                          {pageNum}
                        </button>
                      )
