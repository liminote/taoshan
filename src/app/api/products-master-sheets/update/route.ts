...
async function writeToGoogleSheets(spreadsheetId: string, range: string, values: any[][]) {
...
async function updateGoogleSheets(spreadsheetId: string, range: string, values: any[][]) {
  // 同樣需要認證設定
